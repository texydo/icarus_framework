...
def plot_and_save_histograms(individual_count, pair_count, path='.', filename='histograms_zone_attackers.png', ):
    """
...
def save_dicts(single_dict, pair_dict, dir_path):
    ...
    single_pickle_path = os.path.join(dir_path, "zone_attackers_single_count.pkl")
    pair_pickle_path = os.path.join(dir_path, "zone_attackers_pair_count.pkl")
...
def find_and_process_data(base_path):
    print(f"histogram of zone data collection", flush=True)
    counter = 0
