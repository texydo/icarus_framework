            ...
            if dir_name == 'results':
                ...
                for sub_dir_name in os.listdir(results_dir):
                    ...
                    if os.path.isdir(sub_dir_path):
                        pkl_file_path = os.path.join(sub_dir_path, 'line_attack_grid_count.pkl')
...
def plot_points_on_map(importance_dict, coords_dict):
    ...
    plt.show()
    plt.savefig('/home/roeeidan/icarus_framework/analytics/total_line_map_of_points.png', dpi=300)
